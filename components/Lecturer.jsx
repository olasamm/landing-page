    ...
    <div className="container-fluid text-center mt-5">
        <div className="row">
            <div className="col-12 col-md-6 my-5">
                ...
                <p className="mx-4  my-3 student  fs-10 fs-md-5">Easily submit your assignment, track <br /> deadlines, and receive Feedback-all in <br /> one place. Stay organized and never miss <br /> a deadline again. Our platform is designed <br /> to make learning smoother and stress-free. <br /> Sign up today and stay ahead</p>
